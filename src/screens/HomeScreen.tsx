          ...
          <ScrollView className="flex-1 px-6" showsVerticalScrollIndicator={false}>
            ...
            <View className="mb-8">
              ...
              <View className="flex-row justify-between">
                <View className="flex-1 bg-gradient-to-br from-casino-black-800 to-casino-black-900 rounded-2xl p-5 mr-2 border-2 border-casino-red-600/30">
                  <View className="w-10 h-10 bg-casino-red-600 rounded-xl items-center justify-center mb-3">
                    <Ionicons name="stats-chart" size={24} color="white" />
                  </View>
                  <Text className="text-casino-gold-400 text-sm mb-1 font-semibold">Total</Text>
                  <Text className="text-white text-4xl font-black">
                    {userStats.totalAnalyses}
                  </Text>
                </View>
                <View className="flex-1 bg-gradient-to-br from-yellow-900/40 to-yellow-800/40 rounded-2xl p-5 mx-1 border-2 border-yellow-500/50">
                ...
                <View className="flex-1 bg-gradient-to-br from-casino-gold-900/40 to-casino-gold-800/40 rounded-2xl p-5 ml-2 border-2 border-casino-gold-500/50">
                  <View className="w-10 h-10 bg-casino-gold-500 rounded-xl items-center justify-center mb-3">
                    <Ionicons name="rocket" size={24} color="white" />
                  </View>
                  <Text className="text-casino-gold-200 text-sm mb-1 font-semibold">Alavancar</Text>
                  <Text className="text-white text-4xl font-black">
            ...
            {/* Main Action Button */}
            <View className="bg-gradient-to-br from-casino-red-600 to-casino-red-700 rounded-3xl p-1 mb-8">
              <Pressable
                onPress={() => navigation.navigate("Camera")}
                className="bg-casino-black-900 rounded-3xl p-8 items-center active:opacity-90"
              >
                <View className="w-24 h-24 bg-gradient-to-br from-casino-red-600 to-casino-red-700 rounded-full items-center justify-center mb-4 border-4 border-casino-gold-500">
                  <Ionicons name="images" size={48} color="white" />
                </View>
                <Text className="text-white text-3xl font-black mb-2 text-center">
                  📸 Enviar Foto da Mesa
                </Text>
                <Text className="text-casino-gold-200 text-center text-base leading-6 font-semibold">
                  Escolha uma foto do painel e deixe{"\n"}a magia da IA encontrar suas entradas
                </Text>
                <View className="flex-row items-center mt-4 bg-casino-red-600/20 px-4 py-2 rounded-full">
                  <Ionicons name="flash" size={16} color="#ef4444" />
                  <Text className="text-casino-red-400 text-sm font-bold ml-1">
                    Análise em segundos
                  </Text>
                </View>
              </Pressable>
            ...
            <View className="space-y-4 mb-8">
              <View className="bg-gradient-to-r from-casino-black-800 to-casino-black-900 rounded-2xl p-6 border-2 border-casino-red-600/30">
                <View className="flex-row items-center mb-4">
                  <View className="w-12 h-12 bg-casino-red-600 rounded-2xl items-center justify-center mr-3">
                ...
                <View className="space-y-3">
                  <View className="flex-row items-start">
                    <View className="w-6 h-6 bg-casino-red-600 rounded-full items-center justify-center mr-3 mt-1">
                      <Text className="text-white font-bold text-xs">1</Text>
                    </View>
                    <Text className="text-casino-gold-200 leading-6 flex-1 font-medium">
              ...
              <View className="bg-gradient-to-r from-casino-red-900/40 to-casino-red-800/40 rounded-2xl p-6 border-2 border-casino-gold-500/40">
                <View className="flex-row items-center mb-4">
                  <View className="w-12 h-12 bg-casino-gold-500 rounded-2xl items-center justify-center mr-3">
                    <Ionicons name="disc" size={28} color="white" />
                  </View>
                  <Text className="text-white font-black text-xl">
                    Por Que Funciona?
                  </Text>
                </View>
                <Text className="text-casino-gold-100 leading-7 font-medium">
                  Operamos <Text className="text-white font-bold">a favor da sequência</Text>. Buscamos padrões de <Text className="text-casino-gold-300 font-bold">4+ repetições</Text> em dúzias e colunas.{"\n\n"}
                  <Text className="text-casino-gold-400 font-bold">Quanto maior a sequência, melhor a oportunidade!</Text>
                </Text>
              </View>
            </View>
          </ScrollView>
